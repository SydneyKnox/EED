...
namespace
{
    ...
    const double TRACKIR5V3_FOCALLENGTH    = 1.64;
    const double TRACKIR5V3_PREDIST_FLH    = 583;
    const double TRACKIR5V3_PREDIST_FLV    = 583;
    const double TRACKIR5V3_PREDIST_KC1    = -0.0862667;
    const double TRACKIR5V3_PREDIST_KC2    = 0.230944;
    ...
    const int    PRIME17W_MAXMJPEGRATE   = 360;
